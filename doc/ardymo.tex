...
\begin{table}
    ...
    \cmidrule(l){2-4}
    \multicolumn{1}{c}{Params}& x_{s1}=x_{s0} & y_{s1}=y_{s0} & a_{s}x + b_{s}\\
    \hline
    x=\xsig & \xsig=x_{s0} & 
...
Table~\eqref{tab-distance-seg}, we present the distances for all cases of
...
\begin{table}
    ...
    \begin{tabular}{LLL}
    \toprule
    \multicolumn{1}{c}{Sensor}&\multicolumn{1}{c}{Line Segment}&
    \multicolumn{1}{c}{Distance}\\
    \midrule
    \multicolum{1}{c}{Params}& x_{s1}=x_{s0} & y_{s1}=y_{s0} & a_{s}x + b_{s}\\
    \hline
    x=\xsig & \xsig=x_{s0} & 
        \multicolumn{2}{C}{x_{s0}\leq \xsig\leq x_{s1}} \\
    y=\bsig & y_{s0}\leq \bsig \leq y_{s1} & \bsig=y_{s0} &
